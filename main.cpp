...
//		std::vector<float> t = {1,1,1,1};
	...
	int couldReadStorage = filesave::readStorage("storage.csv", ";", lager);
	int couldReadSuppliers = filesave::readSupplier("suppliers.csv", ";", suppliers);

	Firm eigeneFirma("meineFirma", "meineStr", "01234", "meineStadt", "meinKomment");
	filesave::readFirma("firma.csv",";",eigeneFirma);
...
// nur zum testen fehlte in der Vorstellung
//		case 5:
//		{
//			std::cout<<"\n5 Import"<<std::endl;
//			std::cout<< " 1. Lager \n 2. Zulieferer \n 0. Zurueck"<<std::endl;
...
//			do {
//				std::cin >> importIn;
//				if (functions::eingabe(3, importIn) == -1) {
//					std::cout << "Ungueltige Eingabe, bitte neu eingeben: \n" << std::endl;
//				}
//			} while (functions::eingabe(3, importIn) == -1);
//			int importInInt = stoi(importIn);
//			if(importInInt == 0)
//				break;
//			else if(importInInt == 1){
//				std::string fileName;
//				std::string spacer;
...
//				std::cin>>spacer;
//				while(!data::fileExists(fileName)){
//					std::cout<<"Dateiname existiert nicht"<<std::endl;
//					std::cin>>fileName;
//				}
//				filesave::readStorage(fileName, spacer, lager);
//
//			}else if(importInInt == 2){
//				std::string fileName;
//				std::string spacer;
//				std::cout<<"Dateiname"<<std::endl;
//				std::cin>>fileName;
...
//					std::cin>>fileName;
//				}
//				filesave::readSupplier(fileName, spacer, suppliers);
//
//			}
//
//		}
